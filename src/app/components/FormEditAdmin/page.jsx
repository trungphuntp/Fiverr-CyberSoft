  ...
  useEffect(() => {
    if (!!dataEdit) {
      ...
      if (isTabActive === adminTab.works) {
        ...
        setValueDetailCategory(
          dataEdit?.chaCacLoaiCongViec?.[0]?.dsChiTietLoai
        );
      ...
      if (isTabActive === adminTab.detailCategory) {
        ...
        setLinkThumbnailDetailCategory({
          file: null,
          urlImg: dataEdit?.hinhAnh,
        });
      }
    }
