...
export const deleteDetailCategoryWorksById = async (id) => {
  try {
    const res = await DetailCategoryWorkServices.deleteDetailCategoryWorksById(
      id
    );
    return res.data;
  } catch (error) {
...
export const getDetailCategoryWorksSearch = async (query) => {
  try {
    const res = await DetailCategoryWorkServices.getDetailCategoryWorksSearch(
      query
    );
    return res.data.content;
  } catch (error) {
...
export const updateThumbDetailCategory = async (id, payload) => {
  try {
    const res = await DetailCategoryWorkServices.updateThumbDetailCategory(
      id,
      payload
    );
    return res.data.content;
...
export const addNewItemForDetailCategory = async (payload) => {
  try {
    const res = await DetailCategoryWorkServices.addNewItemForDetailCategory(
      payload
    );
    return res.data.content;
  } catch (error) {
...
export const putNewItemForDetailCategory = async (id, payload) => {
  try {
    const res = await DetailCategoryWorkServices.putNewItemForDetailCategory(
      id,
      payload
    );
    return res.data.content;
