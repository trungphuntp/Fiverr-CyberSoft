                ...
                <div className="grid contentProfile  mx-auto gap-x-4 grid-cols-3  mt-10 mb-10">
                    ...
                    <div className=" col-span-1">
                        ...
                        <div className="social bg-gray-100 p-4 space-y-3 ">
                            ...
                            <a className="flex justify-between " href="https://www.facebook.com/">
                                <Image
                                    alt="Fiverr Image"
                                    src={linkedin_icon}
                                    width={16}
                            ...
                            <a className="flex justify-between " href="https://www.instagram.com/">
                                <Image
                                    alt="Fiverr Image"
                                    src={instagram_icon}
                                    width={16}
                                        ...
                                        hireWorkList.map((item, index) => (
                                            ...
                                            >
                                                ...
                                                <div className="contentHireWork">
                                                    ...
                                                    <p className="textHireWork ">
                                                        {item.congViec.moTa}
                                                    </p>
                                                    <div className="mt-4 buttonHire text-right space-x-2">
                                                        <button
                                                            onClick={() =>
                                                                handleViewDetail(item.congViec.id)
                                                            }
