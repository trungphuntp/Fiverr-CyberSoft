...
const Header = () => {
    return (
        <header className="header">
            ...
            <div className="container-fluid max-lg:hidden ">
                <div className="headerBottomLine"></div>
                <div className="header__bottom  h-[40px]  flex justify-between items-center relative ">
                    <div className="header__bottom-wrapper">
                        <Link className="header__bottom-item" href="#">
                            Graphics & Design
                        </Link>
                        <div className="header__bottom-textbox">
                            <div className="item">
                                <h5 className="item__title">Content Writing</h5>
                                <Link className="item__text" href="#">
                                    Articles & Blog Posts
                                </Link>
                                <Link className="item__text" href="#">
                            ...
                            <div className="item">
                                <h5 className="item__title">Business & Marketing Copy</h5>
                                <Link className="item__text" href="#">
                                    Articles & Blog Posts
                                </Link>
                                <Link className="item__text" href="#">
                            ...
                            <div className="item">
                                <h5 className="item__title">SEO</h5>
                                <Link className="item__text" href="#">
                                    Articles & Blog Posts
                                </Link>
                                <Link className="item__text" href="#">
